function largestColors(largestCol) {
    if(largestCol === "Albanians"){
        ...
        return '#ff0000';
    } else if (largestCol === "Aromanians") {
        return '#d8d335';
    } else if (largestCol === "Arvanites") {
        return '#00d1d1';
    } else if (largestCol === "Romanians") {
        return '#c3ff00';
    } else if (largestCol === "Moldovans") {
        return '#00ffae';
    } else if (largestCol === "Russians") {
        return '#b00000';
    } else if (largestCol === "Gagauzians") {
        return '#ad00b6';
    } else if (largestCol === "Alawites") {
        return '#4f5192';
    } else if (largestCol === "Armenians") {
        return '#51b7b5';
    } else if (largestCol === "Assyrians") {
        return '#0006c1';
    } else if (largestCol === "Azeris" || largestCol === "Azerbaijanis") {
        return '#6651b7';
    } else if (largestCol === "Bangladeshis") {
        return '#ff2f00';
    } else if (largestCol === "Druze") {
        return '#ff62e2';
    } else if (largestCol === "Georgians") {
        return '#ffd15c';
    } else if (largestCol === "Ibadi Arabs") {
        return '#995dde';
    } else if (largestCol === "Indians") {
        return '#ff9d00';
    } else if (largestCol === "Jews") {
        return '#006bc2';
    } else if (largestCol === "Kurds") {
        return '#cc00ff';
    } else if (largestCol === "Lazi") {
        return '#c3ff5c';
    } else if (largestCol === "Maronites") {
        return '#ff0000';
    } else if (largestCol === "Orthodox Arabs") {
        return '#fbff00';
    } else if (largestCol === "Salafi Arabs") {
        return '#93c900';
    } else if (largestCol === "Shia Arabs") {
        return '#00c9b8';
    } else if (largestCol === "South Arabians") {
        return '#c9bf00';
    } else if (largestCol === "Sunni Arabs") {
        return '#00c91b';
    } else if (largestCol === "Syrians") {
        return '#cf1cc6';
    } else if (largestCol === "Yazidis") {
        return '#4d00c1';
    } else if (largestCol === "Zazas") {
        return '#6651b7';
    } else if (largestCol === "Abazins") {
        return '#5d92fd';
    } else if (largestCol === "Adyghe people") {
        return '#805dfd';
    } else if (largestCol === "Aguly") {
        return '#d6c132';
    } else if (largestCol === "Altaians") {
        return '#ff7300';
    } else if (largestCol === "Avars") {
        return '#4000b6';
    } else if (largestCol === "Balkars") {
        return '#7b6fb6';
    } else if (largestCol === "Bashkirs") {
        return '#24b600';
    } else if (largestCol === "Buryats") {
        return '#00ff84';
    } else if (largestCol === "Chechens") {
        return '#00b61b';
    } else if (largestCol === "Chukchi") {
        return '#a61fc4';
    } else if (largestCol === "Chuvash") {
        return '#b69e00';
    } else if (largestCol === "Circassians") {
        return '#5dfd6a';
    } else if (largestCol === "Dargins") {
        return '#5df5a1';
    } else if (largestCol === "Dolgans") {
        return '#c48d1f';
    } else if (largestCol === "Evenks") {
        return '#1fc427';
    } else if (largestCol === "Evens (Lamuts)") {
        return '#76e10b';
    } else if (largestCol === "Ingush") {
        return '#1900ff';
    } else if (largestCol === "Kabardians") {
        return '#71bd00';
    } else if (largestCol === "Kalmyks") {
        return '#00ff8c';
        ...
        return '#ff28b4';
    } else if (largestCol === "Khanty") {
        return '#d3dc56';
    } else if (largestCol === "Komi") {
        return '#009302';
    } else if (largestCol === "Komi-Permyaks") {
        return '#31947e';
    } else if (largestCol === "Koryaks") {
        return '#1fc4bc';
    } else if (largestCol === "Kumyks") {
        return '#fd7557';
    } else if (largestCol === "Laks") {
        return '#00818a';
    } else if (largestCol === "Lezgins") {
        return '#ff8400';
    } else if (largestCol === "Mari") {
        return '#8025ff';
    } else if (largestCol === "Mordva") {
        return '#0e0edd';
    } else if (largestCol === "Nenets") {
        return '#004093';
    } else if (largestCol === "Nogais") {
        return '#ffaa00';
    } else if (largestCol === "Ossetians") {
        return '#ff009d';
    } else if (largestCol === "Rutulians") {
        return '#83dd1d';
    } else if (largestCol === "Soyots") {
        return '#fff700';
    } else if (largestCol === "Tabasarans") {
        return '#901c8a';
    } else if (largestCol === "Tatars") {
        return '#00b0b6';
    } else if (largestCol === "Tuvans") {
        return '#2885ff';
    } else if (largestCol === "Udmurts") {
        return '#db009d';
    } else if (largestCol === "Yakuts (Sakha)") {
        return '#0000ff';
    } else if (largestCol === "Abkhazians") {
        return '#1db545';
    } else if (largestCol === "Aimaq") {
        return '#ff8c40';
        ...
        return '#e3db00';
    } else if (largestCol === "Karakalpaks") {
        return '#cc6eff';
        ...
        return '#ff8c00';
    } else if (largestCol === "Lurs") {
        return '#ab0000';
    } else if (largestCol === "Mazandaranis") {
        return '#00e304';
    } else if (largestCol === "Nuristanis") {
        return '#0874da';
    } else if (largestCol === "Other Turkic") {
        return '#1100ab';
    } else if (largestCol === "Others") {
        return '#2e5d32';
    } else if (largestCol === "Pamiris") {
        return '#e06eff';
    } else if (largestCol === "Pashai") {
        return '#e59e1b';
    } else if (largestCol === "Pashtuns" || largestCol === 'Pashto') {
        return '#f9ff49';
        ...
        return '#ff4545';
    } else if (largestCol === "Talyshs") {
        return '#2200ff';
    } else if (largestCol === "Tats") {
        return '#00f7ff';
    } else if (largestCol === "Turkmens") {
        return '#2c00de';
        ...
        return '#b7244e';
    } else if (largestCol === "Ahirani") {
        return '#50ac5c';
    } else if (largestCol === "Anal") {
        return '#D34251';
    } else if (largestCol === "Angami") {
        return '#502E34';
    } else if (largestCol === "Ao") {
        return '#6D8BA5';
    } else if (largestCol === "Apatani and Others") {
        return '#41AA31';
    } else if (largestCol === "Assamese") {
        return '#f2710e';
    } else if (largestCol === "Awadhi") {
        return '#494C18';
    } else if (largestCol === "Badaga") {
        return '#066509';
    } else if (largestCol === "Bagheli") {
        return '#00ff00';
    } else if (largestCol === "Bagri") {
        return '#55084c';
    } else if (largestCol === "Barel") {
        return '#BF7F6E';
    } else if (largestCol === "Bauti and Others") {
        return '#ff3ad1';
    } else if (largestCol === "Bengali") {
        return '#00e83e';
    } else if (largestCol === "Bhadrawahi") {
        return '#F5C13A';
    } else if (largestCol === "Bhatri") {
        return '#34D3C1';
    } else if (largestCol === "Bhilali") {
        return '#8F394B';
    } else if (largestCol === "Bhili") {
        return '#1e7cef';
    } else if (largestCol === "Bhojpuri") {
        return '#2e5622';
    } else if (largestCol === "Bhotia") {
        return '#1f1f7e';
    } else if (largestCol === "Bilaspuri Kahluri") {
        return '#015AE2';
    } else if (largestCol === "Boro") {
        return '#6b0000';
    } else if (largestCol === "Brajbhasha") {
        return '#2c9400';
    } else if (largestCol === "Bundeli") {
        return '#9a74f9';
    } else if (largestCol === "Chakhesang") {
        return '#FB6273 ';
    } else if (largestCol === "Chakma") {
        return '#639416';
    } else if (largestCol === "Chambeali") {
        return '#0e007b';
    } else if (largestCol === "Chang") {
        return '#b74102';
    } else if (largestCol === "Chhattisgarhi") {
        return '#67009a';
    } else if (largestCol === "Chungli") {
        return '#DE4C93';
    } else if (largestCol === "Churahi") {
        return '#ff5050';
    } else if (largestCol === "Coorgi") {
        return '#334069';
    } else if (largestCol === "Dangi") {
        return '#C9CB8C';
    } else if (largestCol === "Desia") {
        return '#14C470';
    } else if (largestCol === "Dhundhari") {
        return '#487e1f';
    } else if (largestCol === "Dimasa") {
        return '#4D3355 ';
    } else if (largestCol === "Dogri") {
        return '#5c3030';
    } else if (largestCol === "Gaddi") {
        return '#349d99';
    } else if (largestCol === "Garhwali") {
        return '#007494';
    } else if (largestCol === "Garo") {
        return '#dca375';
    } else if (largestCol === "Gojri") {
        return '#A2A58A';
    } else if (largestCol === "Gondi") {
        return '#513407';
    } else if (largestCol === "Gujarati") {
        return '#cf89f8';
    } else if (largestCol === "Halabi") {
        return '#cda4d9';
    } else if (largestCol === "Harauti") {
        return '#00f2ff';
    } else if (largestCol === "Haryanvi") {
        return '#f2ff00';
    } else if (largestCol === "Hindi") {
        return '#ffae00';
    } else if (largestCol === "Hmar") {
        return '#71B0CE';
    } else if (largestCol === "Ho") {
        return '#efdd1e';
    } else if (largestCol === "Jaunpuri") {
        return '#a85050';
    } else if (largestCol === "Kabui") {
        return '#DC3109';
    } else if (largestCol === "Kachchhi") {
        return '#00d9ff';
    } else if (largestCol === "Kangri") {
        return '#af71b1';
    } else if (largestCol === "Kannada") {
        return '#f428ff';
    } else if (largestCol === "Karbi") {
        return '#68358a';
    } else if (largestCol === "Karmali") {
        return '#731F7E';
    } else if (largestCol === "Kashmiri") {
        return '#3a44ff';
    } else if (largestCol === "Khasi") {
        return '#9c6aff';
    } else if (largestCol === "Khezha") {
        return '#4E366F ';
    } else if (largestCol === "Khiemnungan") {
        return '#8509E6';
    } else if (largestCol === "Khortha") {
        return '#681c1c';
    } else if (largestCol === "Kinnauri") {
        return '#89ae00';
    } else if (largestCol === "Kokbarak") {
        return '#b73f24';
    } else if (largestCol === "Konkani") {
        return '#f5fc6d';
    } else if (largestCol === "Konyak") {
        return '#4209de';
    } else if (largestCol === "Korku") {
        return '#a86bde';
    } else if (largestCol === "Koya") {
        return '#6dfcc5';
    } else if (largestCol === "Kui") {
        return '#009dff';
    } else if (largestCol === "Kuki") {
        return '#BFE5D4';
    } else if (largestCol === "Kulvi") {
        return '#ae7700';
    } else if (largestCol === "Kumauni") {
        return '#47086c';
    } else if (largestCol === "Kurukh") {
        return '#b15050';
    } else if (largestCol === "Laria") {
        return '#D991A6';
    } else if (largestCol === "Lepcha") {
        return '#96b702';
    } else if (largestCol === "Liangmei") {
        return '#841BC6';
    } else if (largestCol === "Lotha") {
        return '#A5BA1F';
    } else if (largestCol === "Magahi") {
        return '#DE2B08';
    } else if (largestCol === "Maithili") {
        return '#1c1f68';
    } else if (largestCol === "Malayalam") {
        return '#28edff';
    } else if (largestCol === "Malvi") {
        return '#1f1f7e';
    } else if (largestCol === "Mandeali") {
        return '#ea00ff';
    } else if (largestCol === "Manipuri") {
        return '#233271';
    } else if (largestCol === "Mao") {
        return '#5A230B';
    } else if (largestCol === "Mara") {
        return '#D6A66B';
    } else if (largestCol === "Marathi") {
        return '#00f4e0';
    } else if (largestCol === "Maring") {
        return '#666AA9';
    } else if (largestCol === "Marwari") {
        return '#ff0000';
    } else if (largestCol === "Mewari") {
        return '#DFBAD2';
    } else if (largestCol === "Mewati") {
        return '#65576E';
    } else if (largestCol === "Mishing") {
        return '#45C8D7';
    } else if (largestCol === "Mishmi") {
        return '#5dda15';
    } else if (largestCol === "Mizo") {
        return '#d62dc2';
    } else if (largestCol === "Mongsen and Others") {
        return '#1A912B';
    } else if (largestCol === "Monpa") {
        return '#781815';
    } else if (largestCol === "Munda") {
        return '#04988E';
    } else if (largestCol === "Mundari") {
        return '#1eefad';
    } else if (largestCol === "Nagpuria") {
        return '#EB758C';
        ...
        return '#713270';
    } else if (largestCol === "Nissi") {
        return '#0ec4f2';
    } else if (largestCol === "Nocte") {
        return '#BFC10E';
    } else if (largestCol === "Odia") {
        return '#2517f4';
    } else if (largestCol === "Other Adi") {
        return '#783510';
    } else if (largestCol === "Other Gujarati") {
        return '#3adbff';
    } else if (largestCol === "Other Hindi") {
        return '#4304ae';
        ...
        return '#D76367';
    } else if (largestCol === "Paola") {
        return '#655C1E';
    } else if (largestCol === "Pawi") {
        return '#796BBF';
    } else if (largestCol === "Pawri") {
        return '#667824';
    } else if (largestCol === "Phom") {
        return '#9B57C4';
    } else if (largestCol === "Pnar") {
        return '#0D369D';
    } else if (largestCol === "Pochury") {
        return '#773B05';
    } else if (largestCol === "Purkhi") {
        return '#7f6446';
    } else if (largestCol === "Rajasthani") {
        return '#2b00ff';
    } else if (largestCol === "Reang") {
        return '#A15F59';
    } else if (largestCol === "Rengma") {
        return '#D8A9F3';
    } else if (largestCol === "Rongmei") {
        return '#29ABFE';
    } else if (largestCol === "Sadri") {
        return '#6debf7';
    } else if (largestCol === "Sambalpuri") {
        return '#ff5900';
    } else if (largestCol === "Sangtam") {
        return '#6DB895';
    } else if (largestCol === "Santali") {
        return '#de2899';
    } else if (largestCol === "Savara") {
        return '#ffd900';
    } else if (largestCol === "Siraji") {
        return '#7b0000';
    } else if (largestCol === "Sirmauri") {
        return '#B0F08B';
    } else if (largestCol === "Sondwari") {
        return '#F5B022';
    } else if (largestCol === "Surgujia") {
        return '#0066ff';
    } else if (largestCol === "Surjapuri") {
        return '#484cc5';
    } else if (largestCol === "Tagin") {
        return '#2dbdd6';
        ...
        return '#fffb00';
    } else if (largestCol === "Thado") {
        return '#813D61';
    } else if (largestCol === "Tulu") {
        return '#c9742f';
    } else if (largestCol === "Tutcha Tangsa") {
        return '#DCA38C';
    } else if (largestCol === "Varli") {
        return '#de5b15';
    } else if (largestCol === "Vasava") {
        return '#B9BB18';
    } else if (largestCol === "Wagdi") {
        return '#228733';
    } else if (largestCol === "Wancho") {
        return '#CCF096';
    } else if (largestCol === "War") {
        return '#A3937C';
    } else if (largestCol === "Yimchungre") {
        return '#36BCFB';
    } else if (largestCol === "Zeliang") {
        return '#2DE9F2';
    } else if (largestCol === "Zemi") {
        return '#AF2E1C';
    ...
    } else if (largestCol === "Afar") {
        return '#ff0000';
    } else if (largestCol === "Agew Hamyra") {
        return '#00ff00';
    } else if (largestCol === "Agew-Awi") {
        return '#0000ff';
    } else if (largestCol === "Alaba") {
        return '#ff9900';
    } else if (largestCol === "Amhara") {
        return '#9900ff';
    } else if (largestCol === "Anyiwak") {
        return '#00ffff';
    } else if (largestCol === "Argoba") {
        return '#ff0066';
    } else if (largestCol === "Ari") {
        return '#66ff00';
    } else if (largestCol === "Asu") {
        return '#0066ff';
    } else if (largestCol === "Baganda") {
        return '#ffcc00';
    } else if (largestCol === "Bajuni") {
        return '#cc00ff';
    } else if (largestCol === "Banyakole") {
        return '#00ffcc';
    } else if (largestCol === "Basketo") {
        return '#ff3300';
    } else if (largestCol === "Basoga") {
        return '#33ff00';
    } else if (largestCol === "Bena") {
        return '#0033ff';
    } else if (largestCol === "Bench") {
        return '#ff6600';
    } else if (largestCol === "Berta") {
        return '#6600ff';
    } else if (largestCol === "Bondei") {
        return '#00ff66';
    } else if (largestCol === "Borana") {
        return '#ff0033';
    } else if (largestCol === "Burji") {
        return '#33ffcc';
    } else if (largestCol === "Chagga") {
        return '#ccff33';
    } else if (largestCol === "Chagga-Mashami") {
        return '#ff9933';
    } else if (largestCol === "Chagga-Rombo") {
        return '#9933ff';
    } else if (largestCol === "Chagga-Vunjo") {
        return '#33ff99';
    } else if (largestCol === "Datooga") {
        return '#ff3366';
    } else if (largestCol === "Dawuro") {
        return '#3366ff';
    } else if (largestCol === "Debase/Gewada") {
        return '#66ff33';
    } else if (largestCol === "Digo") {
        return '#ffcc33';
    } else if (largestCol === "Embu") {
        return '#60a14a';
    } else if (largestCol === "Fipa") {
        return '#33ccff';
    } else if (largestCol === "Gabra") {
        return '#ff6633';
    } else if (largestCol === "Gamo") {
        return '#16abf5';
    } else if (largestCol === "Gedeo") {
        return '#33ff66';
    } else if (largestCol === "Gogo") {
        return '#ff3366';
    } else if (largestCol === "Gumuz") {
        return '#3366cc';
    } else if (largestCol === "Guragie") {
        return '#66cc33';
    } else if (largestCol === "Ha") {
        return '#ffcc66';
    } else if (largestCol === "Hadiya") {
        return '#f51634';
    } else if (largestCol === "Hangaza") {
        return '#33cccc';
    } else if (largestCol === "Haya") {
        return '#ff3366';
    } else if (largestCol === "Hehe") {
        return '#3366ff';
    } else if (largestCol === "Iraku") {
        return '#66ff99';
    } else if (largestCol === "Jita") {
        return '#ff9966';
    } else if (largestCol === "Kagulu") {
        return '#9966ff';
    } else if (largestCol === "Kalenjin") {
        return '#e327d6';
    } else if (largestCol === "Kamba") {
        return '#ff6699';
    } else if (largestCol === "Kefficho") {
        return '#336699';
    } else if (largestCol === "Kembata") {
        return '#66cc99';
    } else if (largestCol === "Kerewe") {
        return '#ffcc99';
    } else if (largestCol === "Kikuyu") {
        return '#32c4f0';
    } else if (largestCol === "Kinga") {
        return '#33cc66';
    } else if (largestCol === "Kisii") {
        return '#ff3366';
    } else if (largestCol === "Konso") {
        return '#3366ff';
    } else if (largestCol === "Konta") {
        return '#66ff99';
    } else if (largestCol === "Kore") {
        return '#ff9966';
    } else if (largestCol === "Kurya") {
        return '#9966ff';
    } else if (largestCol === "Kwaya") {
        return '#33cc99';
    } else if (largestCol === "Kwere") {
        return '#ff6699';
    } else if (largestCol === "Langi") {
        return '#b452fa';
    } else if (largestCol === "Luguru") {
        return '#66cc99';
    } else if (largestCol === "Luhya") {
        return '#ffcc99';
    } else if (largestCol === "Luo") {
        return '#cc99ff';
    } else if (largestCol === "Maasai") {
        return '#0cf5b7';
    } else if (largestCol === "Makua") {
        return '#3366ff';
    } else if (largestCol === "Matengo") {
        return '#66ff99';
    } else if (largestCol === "Matumbi") {
        return '#ff9966';
    } else if (largestCol === "Meru") {
        return '#9966ff';
    } else if (largestCol === "Mijikenda") {
        return '#33cc99';
    } else if (largestCol === "Mwera") {
        return '#ff6699';
    } else if (largestCol === "Ndali") {
        return '#336699';
    } else if (largestCol === "Ndamba") {
        return '#66cc99';
    } else if (largestCol === "Ndendeule") {
        return '#ffcc99';
    } else if (largestCol === "Ndengereko") {
        return '#cc99ff';
    } else if (largestCol === "Ngindo") {
        return '#f032bd';
    } else if (largestCol === "Nguu") {
        return '#3366ff';
    } else if (largestCol === "Nilamba") {
        return '#66ff99';
    } else if (largestCol === "Nuwer") {
        return '#0621cc';
    } else if (largestCol === "Nyakyusa") {
        return '#9966ff';
    } else if (largestCol === "Nyambo") {
        return '#ff0000';
    } else if (largestCol === "Nyamwezi") {
        return '#00ff00';
    } else if (largestCol === "Nyaturu") {
        return '#0000ff';
    } else if (largestCol === "Nyiha") {
        return '#ff9900';
    } else if (largestCol === "Orma") {
        return '#ff91ff';
    } else if (largestCol === "Oromo") {
        return '#00ffff';
    } else if (largestCol === "Pangwa") {
        return '#ff0066';
    } else if (largestCol === "Pogoro") {
        return '#66ff00';
    } else if (largestCol === "Pokomo") {
        return '#0066ff';
    } else if (largestCol === "Rangi") {
        return '#ffcc00';
    } else if (largestCol === "Rwanda-Rundi") {
        return '#cc00ff';
    } else if (largestCol === "Safwa") {
        return '#00ffcc';
    } else if (largestCol === "Sambaa") {
        return '#ff3300';
    } else if (largestCol === "Samburu") {
        return '#33ff00';
    } else if (largestCol === "Sangu") {
        return '#0033ff';
    } else if (largestCol === "Shekecho") {
        return '#ff6600';
    } else if (largestCol === "Sidama") {
        return '#6600ff';
    } else if (largestCol === "Silte") {
        return '#d90d91';
    } else if (largestCol === "Somali") {
        return '#2033c7';
    } else if (largestCol === "Subi") {
        return '#33ffcc';
    } else if (largestCol === "Sukuma") {
        return '#ccff33';
    } else if (largestCol === "Swahili") {
        return '#ff9933';
    } else if (largestCol === "Taita") {
        return '#5005ab';
    } else if (largestCol === "Tigre") {
        return '#33ff99';
    } else if (largestCol === "Tigrinya") {
        return '#dec000';
    } else if (largestCol === "Turkana") {
        return '#fffb03';
    } else if (largestCol === "Wolayita") {
        return '#66ff33';
    } else if (largestCol === "Yem") {
        return '#cc33ff';
    } else if (largestCol === "Zalamo") {
        return '#33ccff';
    } else if (largestCol === "Zigua") {
        return '#ff6633';
...
function religionColors(largestCol) {
    if(largestCol === "Orthodox"){
        return '#a20000';
    } else if (largestCol === "Catholics") {
        return '#7028ff';
    } else if (largestCol === "Protestants") {
        return '#005ea2';
    } else if (largestCol === "Christians/ Other Christians" || largestCol === "Christianity") {
        return '#a20059';
    } else if (largestCol === "African Instituted Churches") {
        return '#0016a2';
    } else if (largestCol === "Muslims" || largestCol === "Islam") {
        return '#00a226';
    } else if (largestCol === "Jews") {
        return '#0016a2';
        ...
        return '#4e4e4e';
    } else if (largestCol === "Hinduism") {
        return '#ff8800';
    } else if (largestCol === "Jainism") {
        return '#2600ff';
    } else if (largestCol === "Sikhism") {
        return '#00d0ff';
    } else if (largestCol === "Buddhism") {
        return '#00ffd5';
    } else if (largestCol === "Folk Religions") {
        return '#00ffd5';
    }
