...
<qgis version="3.40.0-Bratislava">
  <identifier>russia shapefiles</identifier>
  <parentidentifier></parentidentifier>
  <language>ENG</language>
  <type>dataset</type>
  <title>Russian Federation Raioni Boundaries</title>
  <abstract>Russian Federation Raioni Boundaries provides a 2022 boundary with a total population count. </abstract>
  <keywords vocabulary="Search keys">
    ...
    <keyword>RU</keyword>
    <keyword>RUS</keyword>
    <keyword>RUS_Boundaries_2022</keyword>
  </keywords>
  <contact>
    <name></name>
  ...
  <dates/>
  <fees></fees>
  <rights>Esri, Michael Bauer Research GmbH 2022, Federal State Statistics Service, Eurostat</rights>
  <encoding></encoding>
  <crs>
